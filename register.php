...
<head>
   ...
   <title>Register - Point Of Sales System</title>
               ...
               <div class="card-body">
                  ...
                  <div class="app-brand justify-content-center mb-6">
                     <a href="index.html" class="app-brand-link gap-2">
                        ...
                        <span class="app-brand-text demo text-heading fw-bold">Point Of Sales System</span>
                     </a>
                  </div>
                  <!-- /Logo -->
                     ...
                     <div class="my-8">
                        <div class="form-check mb-0 ms-2">
                           ...
                           <label class="form-check-label" for="terms-conditions">
                              <span class="text-primary fw-bold">Klik disini, </span> jika data Anda sudah benar.
                           </label>
                        </div>
                     </div>
