<?php
// Dapatkan parameter 'module' dari URL
$pageActive = isset($_GET['module']) ? $_GET['module'] : 'dashboard';
?>

<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
   <div class="app-brand demo">
      <a href="main.php?module=dashboard" class="app-brand-link">
   ...
   <ul class="menu-inner py-1">
      ...
      <li class="menu-item <?= $pageActive == 'dashboard' ? 'active' : '' ?>">
         <a href="?module=dashboard" class="menu-link">
      ...
      <li class="menu-item <?= in_array($pageActive, ['riwayat-transaksi', 'detail-transaksi']) ? 'active' : '' ?>">
         <a href="?module=riwayat-transaksi" class="menu-link">
            <i class="menu-icon tf-icons bx bx-archive"></i>
            <div data-i18n="Archive">Riwayat Transaksi</div>
         </a>
      </li>
      ...
      <li class="menu-item <?= $pageActive == 'laporan' ? 'active' : '' ?>">
         <a href="?module=laporan" class="menu-link">
            ...
            <div data-i18n="file">Laporan</div>
         </a>
      </li>
      <li class="menu-item <?= $pageActive == 'export-excel' ? 'active' : '' ?>">
         <a href="?module=export-excel" class="menu-link">
            <i class="menu-icon tf-icons bx bx-spreadsheet"></i>
            <div data-i18n="Spreadsheet">Export Excel</div>
         </a>
      </li>
